...
// Page component: wraps the actual form in <Suspense>
...
// Inner component: actually uses useSearchParams and handles the form
function StakeholderFormInner() {
